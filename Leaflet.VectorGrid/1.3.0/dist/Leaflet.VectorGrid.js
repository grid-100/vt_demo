...
L.VectorGrid = L.GridLayer.extend({
	...
	_createLayer: function(feat, pxPerExtent, layerStyle) {
		...
		case 1:
			...
			//https://github.com/Leaflet/Leaflet.VectorGrid/issues/236
...
// 			z: this._getZoomForUrl()	/// TODO: Maybe replicate TileLayer's maxNativeZoom
		...
		/*
		//REUSE TILES at maxzoom to render
		if ( coords.z > this.options.dataMaxZoom) {
            var z2 = this.options.dataMaxZoom, multiplier = 1 << (coords.z - z2);
            data.x = Math.floor(coords.x / multiplier),
			data.y = Math.floor(coords.y / multiplier),
            data.z = z2
        }
        else {
            if (coords.z < 0) {
...
L.Canvas.Tile = L.Canvas.extend({
	...
	_onMouseMove: function (e) {
		...
		//console.log(this._map.mouseEventToLayerPoint(e));
